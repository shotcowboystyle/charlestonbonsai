<template>
  <div class="bg-white rounded-2xl shadow-soft p-6 sticky top-24">
    <div class="flex items-center justify-between mb-6">
      <h3 class="font-serif text-lg text-charcoal">Filters</h3>
      <button
    ...
    <!-- Tree Size -->
    <div class="mb-6">
      <h4 class="font-medium text-charcoal mb-3">Size</h4>
    ...
    <!-- Care Level -->
    <div class="mb-6">
      <h4 class="font-medium text-charcoal mb-3">Care Level</h4>
      <div class="flex flex-wrap gap-2">
        <button
    ...
    <!-- Tree Type -->
    <div class="mb-6">
      <h4 class="font-medium text-charcoal mb-3">Species</h4>
      <div class="flex flex-wrap gap-2">
        <button
...
import type { FilterState, TreeSize, CareLevel, TreeType } from '~/types'
