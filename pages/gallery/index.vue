      ...
      <div class="flex flex-col lg:flex-row gap-8">
        ...
        <main class="flex-1">
          ...
          <div v-else-if="trees.length === 0" class="text-center py-16">
            ...
            <h3 class="font-serif text-xl text-charcoal mb-2">No trees found</h3>
            <p class="text-stone-500 mb-6">Try adjusting your filters or search terms</p>
...
import type { Tree, FilterState, TreeSize, CareLevel, TreeType, SortOption } from '~/types'
import { TREE_SIZE_LABELS, CARE_LEVEL_LABELS, TREE_TYPE_LABELS, SORT_OPTIONS } from '~/types'
