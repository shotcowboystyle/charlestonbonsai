    ...
    <div class="w-full max-w-md">
      ...
      <div class="text-center mb-8">
        <NuxtLink to="/" class="inline-flex items-center gap-3">
          ...
          <div class="text-left">
            <div class="font-serif text-xl font-semibold text-charcoal">Charleston Bonsai</div>
            <div class="text-xs text-stone-500">Admin Portal</div>
          </div>
        </NuxtLink>
      </div>
      ...
      <div class="bg-white rounded-2xl shadow-soft p-8">
        <h1 class="font-serif text-2xl text-charcoal text-center mb-6">Sign In</h1>
