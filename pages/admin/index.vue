  ...
  <div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
      <div class="bg-white rounded-xl p-6 shadow-soft">
        ...
        <div class="text-3xl font-serif text-charcoal">{{ stats.total }}</div>
      </div>
      ...
      <div class="bg-white rounded-xl p-6 shadow-soft">
        ...
        <div class="text-3xl font-serif text-charcoal">{{ stats.inStock }}</div>
      </div>
      ...
      <div class="bg-white rounded-xl p-6 shadow-soft">
        ...
        <div class="text-3xl font-serif text-charcoal">{{ stats.featured }}</div>
      </div>
      ...
      <div class="bg-white rounded-xl p-6 shadow-soft">
        ...
        <div class="text-3xl font-serif text-charcoal">${{ stats.totalValue.toLocaleString() }}</div>
      </div>
    </div>

    <!-- Quick Actions -->
    <div class="bg-white rounded-xl p-6 shadow-soft mb-8">
      <h2 class="font-serif text-lg text-charcoal mb-4">Quick Actions</h2>
    ...
    <div class="bg-white rounded-xl shadow-soft overflow-hidden">
      <div class="p-6 border-b border-stone-200">
        <div class="flex items-center justify-between">
          <h2 class="font-serif text-lg text-charcoal">Recent Listings</h2>
